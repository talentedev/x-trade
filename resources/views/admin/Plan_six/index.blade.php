...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active">Plane six</a>
    </nav>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('homeplansixtitleupdate', $title->id) }}" class="btn btn-info">Update</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $six->plan_item }}</td>
                                <td>
                                    <a href="{{ route('six.show', $six->id) }}" class="btn btn-info">Update</a>
                                    <form action="{{ route('six.destroy', $six->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('six.store') }}">
                        @csrf
