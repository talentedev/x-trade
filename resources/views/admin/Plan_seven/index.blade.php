...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active">Plane seven</a>
    </nav>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('homeplanseventitleupdate', $title->id) }}" class="btn btn-info">Update</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-lg-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->index+1 }}</td>
                                <td>{{ $seven->plan_item }}</td>
                                <td>
                                    <a href="{{ route('seven.show', $seven->id) }}" class="btn btn-info">Update</a>
                                    <form action="{{ route('seven.destroy', $seven->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
