...
@section('title')
    Update | Plane three title | Dashboard
@endsection
@section('three')
    active
@endsection
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="{{ route('three.index') }}"> Plane three</a>
        <a class="breadcrumb-item active">Update Plane three title</a>
    </nav>
    
    <div class="sl-pagebody">
        <div class="sl-page-title">
            <h5>Update | Plane three title</h5>
        </div><!-- sl-page-title -->
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('homeplanthreetitleupdatepost', $title->id) }}">
                        @csrf
