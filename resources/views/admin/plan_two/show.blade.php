...
@section('title')
    Update | Plane two item | Dashboard
@endsection
@section('two')
    active
@endsection
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active">Update Plane two item</a>
    </nav>
    
    <div class="sl-pagebody">
        <div class="sl-page-title">
            <h5>Update Plane two item</h5>
        </div><!-- sl-page-title -->
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('two.update', $info->id) }}">
                        @csrf
                        @method('PATCH')
