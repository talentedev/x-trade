...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active">Plane five</a>
    </nav>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('homeplanfivetitleupdate', $title->id) }}" class="btn btn-info">Update</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->index+1 }}</td>
                                <td>{{ $five->plan_item }}</td>
                                <td>
                                    <a href="{{ route('five.show', $five->id) }}" class="btn btn-info">Update</a>
                                    <form action="{{ route('five.destroy', $five->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('five.store') }}">
                        @csrf
