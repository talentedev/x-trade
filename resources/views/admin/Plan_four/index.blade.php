...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item active">Plane four</a>
    </nav>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('homeplanfourtitleupdate', $title->id) }}" class="btn btn-info">Update</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->index+1 }}</td>
                                <td>{{ $four->plan_item }}</td>
                                <td>
                                    <a href="{{ route('four.show', $four->id) }}" class="btn btn-info">Update</a>
                                    <form action="{{ route('four.destroy', $four->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('four.store') }}">
                        @csrf
